  ...
  return (
    <div className="max-w-5xl mx-auto px-4">
      ...
      >
                    ...
                    <CardContent className="p-6">
                      <Quote
                        className={cn(
                          ...
                          isCenter ? "text-primary/60" : "text-muted-foreground/20"
                        )}
                      />
        ...
        <CarouselPrevious className="-left-2 sm:-left-4 md:-left-12 bg-card/80 border-border hover:bg-accent hover:border-primary/30 text-foreground backdrop-blur-sm" />
        <CarouselNext className="-right-2 sm:-right-4 md:-right-12 bg-card/80 border-border hover:bg-accent hover:border-primary/30 text-foreground backdrop-blur-sm" />
      </Carousel>
