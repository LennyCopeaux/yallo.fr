  ...
  return (
    <div className="space-y-6">
      <Card className="border-border bg-card/30">
        <CardHeader>
          <CardTitle>État de l&apos;agent IA</CardTitle>
          <CardDescription>{statusText.description}</CardDescription>
        </CardHeader>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="space-y-1">
              ...
              {isFullyOperational ? (
                ...
                <AdminStatusBadge tone="warning" label="Partiellement configuré" />
              ) : (
            ...
            <div className="space-y-1">
              ...
              <p className="font-medium">{restaurant.elevenLabsAgentId || "—"}</p>
            </div>
            <div className="space-y-1">
              <p className="text-xs text-muted-foreground font-medium uppercase tracking-wide">
                Numéro lié
              </p>
              <p className="font-medium">{hasPhoneLinked ? restaurant.twilioPhoneNumber : "—"}</p>
            </div>
          </div>
        </CardContent>
      </Card>
