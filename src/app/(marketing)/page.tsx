...
export default function Home() {
  return (
    <div className="relative">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center relative">
          ...
          >
            ...
            >
              <Button
                size="lg"
                className="text-base sm:text-lg px-8 h-14 bg-primary text-primary-foreground hover:bg-primary/90 btn-shine font-semibold glow-yellow-subtle"
              >
                Essayer la démo
              ...
              <Button
                variant="outline"
                size="lg"
                className="text-base sm:text-lg px-8 h-14 border-border hover:border-white/20 hover:bg-accent"
              >
                Voir une vidéo
              </Button>
            </motion.div>
          ...
          >
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="relative glass-strong rounded-3xl p-3 sm:p-4 border-border">
                <div className="bg-background/80 rounded-2xl overflow-hidden border border-border/50">
                  {/* Status bar */}
                  <div className="bg-card/50 px-4 py-2 flex items-center justify-between border-b border-border/50">
                  ...
                  <div className="p-4 sm:p-6 space-y-4">
                    ...
                    {[
                      ...
                      <motion.div
                        ...
                        className="bg-card/30 rounded-xl p-4 border border-border/50 hover:border-border transition-colors"
                      >
                        <div className="flex items-start justify-between gap-3">
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1">
                              <span className="font-bold text-foreground">{order.id}</span>
                              <span className={`${order.color} ${order.color === 'bg-primary' ? 'text-primary-foreground' : 'text-white'} text-xs px-2 py-0.5 rounded-full font-medium`}>
                                {order.status}
                              </span>
                            </div>
                          ...
                          <Button size="sm" variant="ghost" className="shrink-0 hover:bg-accent">
                            Voir
                          </Button>
                        </div>
                      </motion.div>
      ...
      {/* ===================== SOCIAL PROOF ===================== */}
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 border-y border-border/50">
        <motion.div
          initial={{ opacity: 0 }}
            ...
            >
              ...
              <div className="flex flex-wrap gap-3">
                {["Réponse instantanée", "24h/24", "Sans file d'attente"].map((tag) => (
                  <span key={tag} className="text-sm px-3 py-1 rounded-full bg-muted/50 text-muted-foreground border border-border/50">
                    {tag}
                  </span>
                ))}
              </div>
      ...
      {/* ===================== BENTO FEATURES GRID ===================== */}
      <section id="features" className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 border-t border-border/50">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-100px" }}
        ...
        <motion.div
          ...
          >
            <Card className="h-full bg-card/30 border-border/50 hover:border-primary/30 transition-colors duration-300 noise overflow-hidden">
              ...
              <CardContent>
                ...
                <div className="mt-6 flex gap-2 flex-wrap">
                  {["Accents", "Slang", "Multilingue", "24/7"].map((tag) => (
                    <span key={tag} className="text-xs px-3 py-1 rounded-full bg-muted/50 text-muted-foreground border border-border/50">
                      {tag}
                    </span>
                  ))}
                </div>
          ...
          >
            <Card className="h-full bg-card/30 border-border/50 hover:border-primary/30 transition-colors duration-300 noise">
              <CardHeader>
                <div className="w-14 h-14 rounded-2xl bg-primary/10 flex items-center justify-center mb-4 group-hover:bg-primary/20 transition-colors">
      ...
      */}
      ...
      {/* ===================== PRICING ===================== */}
      <section id="pricing" className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 border-t border-border/50 overflow-hidden">
        ...
        <div className="relative z-10 grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <Card className="flex flex-col h-full bg-card/30 border-border hover:border-white/30 transition-all duration-300 noise group">
              ...
              <CardContent className="flex flex-col flex-1 space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3">
                    <div className={`w-5 h-5 rounded-full flex items-center justify-center shrink-0 ${item.highlight ? 'bg-primary/20' : 'bg-white/10'}`}>
                ...
                <Button variant="outline" className="w-full mt-auto h-12 border-white/20 hover:border-white/40 hover:bg-accent transition-all duration-300" size="lg">
                  Choisir ce plan
                </Button>
              </CardContent>
            </Card>
          ...
          >
            ...
            <Card className="relative flex flex-col h-full border-primary overflow-hidden noise" style={{
              ...
              <div className="absolute top-4 right-4">
                <Badge className="bg-primary text-primary-foreground font-semibold shadow-lg shadow-primary/30">
              ...
              <CardContent className="flex flex-col flex-1 space-y-4">
                ...
                <Button className="w-full mt-auto h-12 bg-primary text-primary-foreground hover:bg-primary/90 btn-shine font-semibold shadow-lg shadow-primary/30 transition-all duration-300" size="lg">
      ...
      <section id="faq" className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 pb-16">
        ...
        >
            <div className="lg:sticky lg:top-32">
              ...
              {/* Support Block */}
              <div className="p-5 rounded-2xl bg-card/30 border border-border/50 noise">
                ...
                {[
                  ...
                  { q: "Quel est le coût par commande ?", a: "Avec notre formule commission, vous payez 5% par commande traitée. Aucun frais fixe, aucun engagement. Vous ne payez que ce que vous utilisez réellement." },
                    ...
                    <AccordionItem
                      key={i}
                      value={`item-${i}`}
                      className={`border border-border/50 rounded-xl px-5 data-[state=open]:border-primary/30 data-[state=open]:bg-primary/5 transition-all duration-300 ${i === 5 ? 'mb-0' : 'mb-3'}`}
                    >
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
          ...
          transition={{ duration: 0.6 }}
            ...
            <p className="text-lg sm:text-xl text-muted-foreground mb-10">
              ...
              <Button size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 h-14 px-8 text-lg btn-shine font-semibold glow-yellow">
                  Démarrer l&apos;essai gratuit
                  <ArrowRight className="w-5 h-5 ml-2" />
                </Button>
              <Button size="lg" variant="outline" className="border-border hover:border-white/20 h-14 px-8 text-lg">
                  Parler à un expert
                </Button>
              </div>
      ...
      <footer className="relative overflow-hidden">
        ...
        {/* Bottom bar */}
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 border-t border-border/50">
